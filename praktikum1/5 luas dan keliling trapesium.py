...
class FrmTrapesium:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Sisi Miring:').grid(row=2, column=0, sticky=W, padx=5, pady=5)
        ...
        # pasang textbox
        self.txtAtas = Entry(mainFrame)
        self.txtAtas.grid(row=0, column=1, padx=5, pady=5)
        self.txtBawah = Entry(mainFrame)
        self.txtBawah.grid(row=1, column=1, padx=5, pady=5)
        self.txtMiring = Entry(mainFrame)
        self.txtMiring.grid(row=2, column=1, padx=5, pady=5)
    ...
    # fungsi untuk menghitung luas dan kelilig Trapesium
    def onHitung(self, event=None):
        # perhitungan dengan metode Pemrograman Tidak Terstruktur
        atas = int(self.txtAtas.get())
        bawah = int(self.txtBawah.get())
        miring = int(self.txtMiring.get())
